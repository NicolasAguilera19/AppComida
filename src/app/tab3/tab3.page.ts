...
export class Tab3Page {
  ...
  crearMensaje():string{
   let parteProductos = '';
   this.cartService.carrito.forEach(_productoCarrito =>{
    const mensajeProducto = '- ${productoCarrito.producto.nombre} - ${productoCarrito.producto.cantidad}'
    parteProductos = parteProductos + mensajeProducto;
  })
    const primeraParte = "https"
